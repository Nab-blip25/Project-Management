...
- Some images, PDFs or the promotional video referenced on the main page may not be present.
...
## Link to original development history
For evidence that the project was developed with periodic Git usage, you can check the initial repository commit history at:
https://github.com/eliRue53/ProjetPingV1/commits/main

This link points to the original repo at the time of writing; it will only work if the owner still keeps that repository public and unchanged.
Please note that the code in this repository was originally committed from my school account, while this copy is hosted under my personal account.
